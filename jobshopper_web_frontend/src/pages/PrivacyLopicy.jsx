      ...
      <div className="w-11/12 mx-auto py-10">
        ...
        <div className="flex flex-col gap-3 py-2">
          <p>
            ...
            following reasons: To facilitate our Service; <br />
        ...
        <div className="py-2">
          <p className="text-xl font-semibold  text-btn-primary">Security</p>
          <p>
        ...
        <div className="py-2">
          ...
          <p>
            ...
            page. This policy is effective as of 2021-12-30
          </p>
        </div>
        <div className="py-2">
          <p className="text-xl font-semibold  text-btn-primary">Contact Us</p>
          <p>
            If you have any questions or suggestions about our Privacy Policy,
            do not hesitate to contact us at{" "}
            <span className="text-btn-primary"> info@jobsshopper.com.</span>
          </p>
        </div>
      </div>
    </div>
